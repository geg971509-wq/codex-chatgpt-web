...
const en = {
  ...
  supportBody: "Star the repository and open the upstream author’s X profile to help more developers find Codex Web GPT.",
  star: "Star on GitHub",
  starred: "GitHub opened",
  follow: "Upstream author on X",
  followed: "X opened",
...
const zh: Record<keyof typeof en, string> = {
  ...
  continue: "继续",
  supportTitle: "开始之前",
  supportBody: "请为仓库 Star，并打开上游作者的 X 主页，帮助更多开发者发现 Codex Web GPT。",
...
const ja: Record<keyof typeof en, string> = {
  ...
  continue: "続ける",
  supportTitle: "開始する前に",
  supportBody: "より多くの開発者に Codex Web GPT を知ってもらうため、リポジトリに Star を付け、上流作者の X プロフィールを開いてください。",
  star: "GitHub で Star",
